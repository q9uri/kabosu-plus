...
from kabosu_plus.sbv2.constants import DEFAULT_USER_DICT_DIR
...
from kabosu_plus.sbv2.nlp.japanese.user_dict.word_model import UserDictWord, WordTypes
...
def update_dict(
    ...
    try:
        ...
        if compiled_dict_path.is_file():
            update_global_jtalk_with_user_dict(user_dictionary=str(compiled_dict_path))
